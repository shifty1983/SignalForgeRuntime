# src/backtesting/historical_research_handoff_log.py
...
LOG_EVENT_TYPE = "historical_research_handoff.operation_recorded"


def build_historical_research_handoff_log_event(
...
def write_historical_research_handoff_log_event(
    operation_record: Mapping[str, Any],
    log_path: str | Path,
) -> dict[str, Any]:
    path = Path(log_path)
    ...
    event = build_historical_research_handoff_log_event(operation_record)
