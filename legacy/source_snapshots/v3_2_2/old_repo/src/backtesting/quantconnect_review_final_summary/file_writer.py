...
FILE_WRITER_SCHEMA_VERSION = "quantconnect_review_final_summary_files.v1"
OPERATION_TYPE = "quantconnect_review_final_summary_file_writer"

DEFAULT_FILENAMES = {
    "final_summary": "quantconnect_review_final_summary.json",
    "operation_result": "quantconnect_review_final_summary_operation.json",
    "audit_report": "quantconnect_review_final_summary_audit.json",
    "health_report": "quantconnect_review_final_summary_health.json",
    "final_evidence_items": "quantconnect_review_final_summary_evidence_items.json",
    "event_log": "quantconnect_review_final_summary_operation.jsonl",
}


def write_quantconnect_review_final_summary_files(
    review_pipeline_result: Any,
    *,
    output_dir: str | PathLike[str],
) -> dict[str, Any]:
    """Write QuantConnect review final summary artifacts to local JSON/JSONL files.
    ...
    files from an existing review pipeline result.
    """
    ...
    operation_result = run_quantconnect_review_final_summary_operation(
    ...
    files = {
        ...
        "final_evidence_items": output_path
        / DEFAULT_FILENAMES["final_evidence_items"],
    ...
    _write_json(
        files["final_evidence_items"],
        _as_list(final_summary.get("final_evidence_items")),
    )
