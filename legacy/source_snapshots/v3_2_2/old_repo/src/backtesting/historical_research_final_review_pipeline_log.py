# src/backtesting/historical_research_final_review_pipeline_log.py
...
LOG_EVENT_TYPE = "historical_research_final_review_pipeline_operation.operation_recorded"


def build_historical_research_final_review_pipeline_log_event(
    ...
    return {
        ...
        "operation_type": operation_record.get(
            "operation_type",
            "historical_research_final_review_pipeline_operation",
        ),
        ...
        "source_pipeline_id": operation_record.get("source_pipeline_id"),
...
def write_historical_research_final_review_pipeline_log_event(
    operation_record: Mapping[str, Any],
    log_path: str | Path,
) -> dict[str, Any]:
    path = Path(log_path)
    ...
    event = build_historical_research_final_review_pipeline_log_event(operation_record)
