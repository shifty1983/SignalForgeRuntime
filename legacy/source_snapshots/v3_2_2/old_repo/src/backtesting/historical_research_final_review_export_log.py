# src/backtesting/historical_research_final_review_export_log.py
...
LOG_EVENT_TYPE = "historical_research_final_review_export.operation_recorded"


def build_historical_research_final_review_export_log_event(
    ...
    return {
        ...
        "operation_type": operation_record.get(
            "operation_type",
            "historical_research_final_review_export",
        ),
...
def write_historical_research_final_review_export_log_event(
    operation_record: Mapping[str, Any],
    log_path: str | Path,
) -> dict[str, Any]:
    path = Path(log_path)
    ...
    event = build_historical_research_final_review_export_log_event(operation_record)
