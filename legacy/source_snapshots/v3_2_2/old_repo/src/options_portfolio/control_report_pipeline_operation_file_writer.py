...
from src.options_portfolio.control_report_pipeline_operation import (
    run_options_portfolio_control_report_pipeline_operation,
)


FILE_WRITER_SCHEMA_VERSION = "options_portfolio_control_report_pipeline_operation_files.v1"
OPERATION_TYPE = "options_portfolio_control_report_pipeline_operation_file_writer"

DEFAULT_FILENAMES = {
    "operation_result": "options_portfolio_control_report_pipeline_operation.json",
    "operation_record": "options_portfolio_control_report_pipeline_operation_record.json",
    "audit_report": "options_portfolio_control_report_pipeline_audit.json",
    "health_report": "options_portfolio_control_report_pipeline_health.json",
    "events": "options_portfolio_control_report_pipeline_operation_events.json",
    "event_log": "options_portfolio_control_report_pipeline_operation.jsonl",
}


def write_options_portfolio_control_report_pipeline_operation_files(
    source: Any,
    *,
    ...
    operation_result = run_options_portfolio_control_report_pipeline_operation(
    ...
    files = {
        ...
        "operation_record": output_path / DEFAULT_FILENAMES["operation_record"],
    ...
    _write_json(files["operation_record"], operation_record)
    ...
    return {
        ...
        "pipeline_summary": operation_result.get("pipeline_summary", {}),
