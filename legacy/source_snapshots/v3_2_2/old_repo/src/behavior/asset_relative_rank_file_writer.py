...
ASSET_RELATIVE_RANK_RESULT_FILENAME = "signalforge_asset_relative_rank.json"
ASSET_RELATIVE_RANK_SUMMARY_FILENAME = "signalforge_asset_relative_rank_summary.json"
ASSET_RELATIVE_RANK_CLI_SUMMARY_SCHEMA_VERSION = (
    "signalforge_asset_relative_rank_cli_summary.v1"
)


def write_asset_relative_rank_result(
    ...
    result_path = output_path / ASSET_RELATIVE_RANK_RESULT_FILENAME
    summary_path = output_path / ASSET_RELATIVE_RANK_SUMMARY_FILENAME
    ...
    summary = build_asset_relative_rank_summary(
        result=result,
...
def build_asset_relative_rank_summary(
    *,
    result: Mapping[str, Any],
    result_path: Path,
    summary_path: Path,
    ...
    summary = result.get("relative_rank_summary") or {}

    return {
        "schema_version": ASSET_RELATIVE_RANK_CLI_SUMMARY_SCHEMA_VERSION,
        "operation_type": "signalforge_asset_relative_rank_cli",
        ...
        "relative_rank_summary": summary,
        "top_universe_strength_symbols": summary.get("top_universe_strength_symbols", []),
        "top_universe_weakness_symbols": summary.get("top_universe_weakness_symbols", []),
        "top_direction_fit_symbols": summary.get("top_direction_fit_symbols", []),
        "top_long_relative_strength_symbols": summary.get(
            "top_long_relative_strength_symbols",
            [],
        ),
        "top_short_relative_weakness_symbols": summary.get(
            "top_short_relative_weakness_symbols",
            [],
        ),
        "top_neutral_stability_symbols": summary.get(
        ...
        "files": {
            "asset_relative_rank_result": str(result_path),
