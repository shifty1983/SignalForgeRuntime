...
RESULT_FILENAME = "signalforge_quantconnect_cloud_object_store_download.json"
SUMMARY_FILENAME = "signalforge_quantconnect_cloud_object_store_download_summary.json"


def write_signalforge_quantconnect_cloud_object_store_download(
    ...
    summary = {
        "operation_type": "signalforge_quantconnect_cloud_object_store_download_cli",
        "adapter_type": result.get("adapter_type"),
        "artifact_type": result.get("artifact_type"),
        "schema_version": "signalforge_quantconnect_cloud_object_store_download_cli_summary.v1",
        ...
        "files": {
            "object_store_download_result": str(result_path),
        ...
        "file_summary": {
            ...
            "empty_files": [],
            "file_sizes": {
                "object_store_download_result": result_path.stat().st_size if result_path.exists() else 0,
        ...
        "downloaded_batch_count": result.get("downloaded_batch_count"),
        "failed_download_batch_count": result.get("failed_download_batch_count"),
        "failed_download_batch_ids": list(result.get("failed_download_batch_ids", [])),
        "expected_result_file_count": result.get("expected_result_file_count"),
        "downloaded_file_count": result.get("downloaded_file_count"),
        "object_store_download_summary": dict(result.get("object_store_download_summary", {})),
