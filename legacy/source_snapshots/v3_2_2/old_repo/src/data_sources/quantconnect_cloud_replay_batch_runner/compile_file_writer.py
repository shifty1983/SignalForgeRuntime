...
RESULT_FILENAME = "signalforge_quantconnect_cloud_replay_compile_execution.json"
SUMMARY_FILENAME = "signalforge_quantconnect_cloud_replay_compile_execution_summary.json"


def write_signalforge_quantconnect_cloud_replay_compile_execution(
    ...
    summary = {
        "operation_type": "signalforge_quantconnect_cloud_replay_compile_execution_cli",
        "adapter_type": result.get("adapter_type"),
        "artifact_type": result.get("artifact_type"),
        "schema_version": "signalforge_quantconnect_cloud_replay_compile_execution_cli_summary.v1",
        ...
        "files": {
            "compile_execution_result": str(result_path),
        ...
        "file_summary": {
            ...
            "empty_files": [],
            "file_sizes": {
                "compile_execution_result": result_path.stat().st_size if result_path.exists() else 0,
        ...
        "compiled_batch_count": result.get("compiled_batch_count"),
        "failed_compile_batch_count": result.get("failed_compile_batch_count"),
        "failed_compile_batch_ids": list(result.get("failed_compile_batch_ids", [])),
        "compile_execution_summary": dict(result.get("compile_execution_summary", {})),
