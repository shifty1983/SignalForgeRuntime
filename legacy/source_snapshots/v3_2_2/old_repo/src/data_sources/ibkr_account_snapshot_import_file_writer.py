...
from src.signalforge.data_sources.ibkr_account_snapshot_import import (
    build_signalforge_ibkr_account_snapshot_import,
)


FILE_WRITER_SCHEMA_VERSION = "signalforge_ibkr_account_snapshot_import_files.v1"
OPERATION_TYPE = "signalforge_ibkr_account_snapshot_import_file_writer"

DEFAULT_FILENAMES = {
    "import_result": "signalforge_ibkr_account_snapshot_import.json",
    "summary": "signalforge_ibkr_account_snapshot_import_summary.json",
}


def write_signalforge_ibkr_account_snapshot_import_files(
    source: Any,
    *,
    ...
    import_result = build_signalforge_ibkr_account_snapshot_import(source)
...
def _build_summary(
    *,
    ...
    validation = _as_mapping(import_result.get("validation_artifact"))

    return {
        "schema_version": "signalforge_ibkr_account_snapshot_import_summary.v1",
        "artifact_type": "signalforge_ibkr_account_snapshot_import_summary",
        "status": import_result.get("status", "needs_review"),
        ...
        "account_summary": dict(_as_mapping(import_result.get("account_summary"))),
        "position_summary": dict(_as_mapping(import_result.get("position_summary"))),
