...
FILE_WRITER_SCHEMA_VERSION = "signalforge_options_backtest_evidence_import_files.v1"
OPERATION_TYPE = "signalforge_options_backtest_evidence_import_file_writer"

DEFAULT_FILENAMES = {
    "import_result": "signalforge_options_backtest_evidence_import.json",
    "summary": "signalforge_options_backtest_evidence_import_summary.json",
}


def write_signalforge_options_backtest_evidence_import_files(
    source: Any,
    *,
    ...
    import_result = build_signalforge_options_backtest_evidence_import(source)
...
def _build_summary(
    *,
    ...
    return {
        "schema_version": "signalforge_options_backtest_evidence_import_summary.v1",
        "artifact_type": "signalforge_options_backtest_evidence_import_summary",
        "status": import_result.get("status", "needs_review"),
        ...
        "backtest_summary": dict(_as_mapping(import_result.get("backtest_summary"))),
