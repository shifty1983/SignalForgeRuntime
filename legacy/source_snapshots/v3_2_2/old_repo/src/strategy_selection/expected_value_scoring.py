...
RISK_PENALTY_MAP = {
    "regime_penalty": 0.08,
    "asset_risk_penalty": 0.08,
    "gamma_risk_penalty": 0.10,
    "theta_decay_penalty": 0.06,
    "liquidity_penalty": 0.12,
}

CONSTRAINT_PENALTY_MAP = {
    "defined_risk_only": 0.02,
    "no_naked_short_premium": 0.02,
    "no_unhedged_short_premium": 0.02,
    "discourage_long_unhedged_premium": 0.01,
}

BASE_SCORE_FAVORED = 0.62
BASE_SCORE_ALLOWED = 0.50
PREMIUM_ALIGNMENT_BONUS = 0.12
PREMIUM_MISMATCH_PENALTY = 0.10
CONSTRAINED_REVIEW_PENALTY = 0.03
