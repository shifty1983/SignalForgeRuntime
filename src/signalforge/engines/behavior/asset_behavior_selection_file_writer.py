...
ASSET_BEHAVIOR_SELECTION_RESULT_FILENAME = "signalforge_asset_behavior_selection.json"
ASSET_BEHAVIOR_SELECTION_SUMMARY_FILENAME = "signalforge_asset_behavior_selection_summary.json"
ASSET_BEHAVIOR_SELECTION_CLI_SUMMARY_SCHEMA_VERSION = (
    "signalforge_asset_behavior_selection_cli_summary.v1"
)


def write_asset_behavior_selection_result(
    ...
    result_path = output_path / ASSET_BEHAVIOR_SELECTION_RESULT_FILENAME
    summary_path = output_path / ASSET_BEHAVIOR_SELECTION_SUMMARY_FILENAME
    ...
    summary = build_asset_behavior_selection_summary(
        result=result,
...
def build_asset_behavior_selection_summary(
    *,
    result: Mapping[str, Any],
    result_path: Path,
    summary_path: Path,
    ...
    return {
        "schema_version": ASSET_BEHAVIOR_SELECTION_CLI_SUMMARY_SCHEMA_VERSION,
        "operation_type": "signalforge_asset_behavior_selection_cli",
        ...
        "regime_artifact_type": result.get("regime_artifact_type"),
        ...
        "files": {
            "selection_result": str(result_path),
        ...
        "file_summary": {
            ...
            "empty_files": [],
            "file_sizes": {
                "selection_result": result_path.stat().st_size if result_path.exists() else 0,
