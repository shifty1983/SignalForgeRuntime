...
SOURCE_DIR = OUTPUT_ROOT / "stage1_artifact_mirror" / "12b_native_quote_walkforward_prune_validation"
GENERATED_DIR = OUTPUT_ROOT / "stage15_native_quote_walkforward_prune_validation_rebuild"

ROW_CHECKS = [
    {
        "label": "results",
        "source": SOURCE_DIR / "walkforward_prune_validation_results.jsonl",
        "generated": GENERATED_DIR / "signalforge_v3_2_1_native_quote_walkforward_prune_validation_results.jsonl",
    },
    {
        "label": "skipped_rows",
        "source": SOURCE_DIR / "walkforward_prune_validation_skipped_rows.jsonl",
        "generated": GENERATED_DIR / "signalforge_v3_2_1_native_quote_walkforward_prune_validation_skipped_rows.jsonl",
    },
]

GENERATED_SUMMARY = GENERATED_DIR / "signalforge_v3_2_1_native_quote_walkforward_prune_validation_summary.json"
...
def build_stage15_walkforward_prune_validation_rebuild_validation() -> dict[str, Any]:
    blockers: list[str] = []
    ...
    return {
        "adapter_type": "migrated_workflow_stage15_walkforward_prune_validation_rebuild_validation_builder",
        "artifact_type": "signalforge_migrated_workflow_stage15_walkforward_prune_validation_rebuild_validation",
        ...
        "readiness_scope": "migrated_walkforward_prune_validation_rebuild_matches_source_row_count_schema_and_hash",
    }
...
def main() -> int:
    ...
    output_path = OUTPUT_ROOT / "signalforge_migrated_workflow_stage15_walkforward_prune_validation_rebuild_validation.json"
