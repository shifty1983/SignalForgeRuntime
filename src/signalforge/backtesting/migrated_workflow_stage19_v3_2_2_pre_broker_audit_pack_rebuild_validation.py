...
SOURCE_DIR = OUTPUT_ROOT / "stage1_artifact_mirror" / "16b_v3_2_2_pre_broker_audit_pack"
GENERATED_DIR = OUTPUT_ROOT / "stage19_v3_2_2_pre_broker_audit_pack_rebuild"

ROW_CHECKS = [
    {
        "label": "capacity_rows",
        "source": SOURCE_DIR / "v3_2_2_capacity_liquidity_rows.jsonl",
        "generated": GENERATED_DIR / "signalforge_v3_2_2_capacity_liquidity_rows.jsonl",
    },
    {
        "label": "lineage_rows",
        "source": SOURCE_DIR / "v3_2_2_no_lookahead_lineage_rows.jsonl",
        "generated": GENERATED_DIR / "signalforge_v3_2_2_no_lookahead_lineage_rows.jsonl",
    },
    {
        "label": "stability_rows",
        "source": SOURCE_DIR / "v3_2_2_period_stability_rows.jsonl",
        "generated": GENERATED_DIR / "signalforge_v3_2_2_period_stability_rows.jsonl",
    },
]

GENERATED_SUMMARY = GENERATED_DIR / "signalforge_v3_2_2_pre_broker_audit_pack_summary.json"
...
def build_stage19_v3_2_2_pre_broker_audit_pack_rebuild_validation() -> dict[str, Any]:
    blockers: list[str] = []
    ...
    return {
        "adapter_type": "migrated_workflow_stage19_v3_2_2_pre_broker_audit_pack_rebuild_validation_builder",
        "artifact_type": "signalforge_migrated_workflow_stage19_v3_2_2_pre_broker_audit_pack_rebuild_validation",
        ...
        "readiness_scope": "migrated_v3_2_2_pre_broker_audit_pack_rebuild_matches_source_row_count_schema_and_hash",
    }


def main() -> int:
    result = build_stage19_v3_2_2_pre_broker_audit_pack_rebuild_validation()

    output_path = OUTPUT_ROOT / "signalforge_migrated_workflow_stage19_v3_2_2_pre_broker_audit_pack_rebuild_validation.json"
