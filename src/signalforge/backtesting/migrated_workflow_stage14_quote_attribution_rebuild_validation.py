...
SOURCE_DIR = OUTPUT_ROOT / "stage1_artifact_mirror" / "11b_quote_attribution_full"
GENERATED_DIR = OUTPUT_ROOT / "stage14_quote_attribution_rebuild"

ROW_CHECKS = [
    {
        "label": "group_rows",
        "source": SOURCE_DIR / "quote_attribution_groups.jsonl",
        "generated": GENERATED_DIR / "signalforge_v3_2_1_native_quote_attribution_groups.jsonl",
    },
    {
        "label": "top_rows",
        "source": SOURCE_DIR / "quote_attribution_top_rows.jsonl",
        "generated": GENERATED_DIR / "signalforge_v3_2_1_native_quote_attribution_top_rows.jsonl",
    },
]

GENERATED_SUMMARY = GENERATED_DIR / "signalforge_v3_2_1_native_quote_attribution_summary.json"
...
def build_stage14_quote_attribution_rebuild_validation() -> dict[str, Any]:
    blockers: list[str] = []
    ...
    return {
        "adapter_type": "migrated_workflow_stage14_quote_attribution_rebuild_validation_builder",
        "artifact_type": "signalforge_migrated_workflow_stage14_quote_attribution_rebuild_validation",
        ...
        "generated_summary_core": {
            ...
            "native_quote_stress_decision": summary.get("native_quote_stress_decision"),
        },
        "blocker_count": len(blockers),
        "blockers": blockers,
        "is_ready": len(blockers) == 0,
        "readiness_scope": "migrated_native_quote_attribution_rebuild_matches_source_row_count_schema_and_hash",
    }


def main() -> int:
    result = build_stage14_quote_attribution_rebuild_validation()

    output_path = OUTPUT_ROOT / "signalforge_migrated_workflow_stage14_quote_attribution_rebuild_validation.json"
