...
GENERATED_DIR = OUTPUT_ROOT / "stage10_selected_trade_sequence_rebuild"
GENERATED_ROWS = GENERATED_DIR / "signalforge_portfolio_selected_trade_sequence.jsonl"
GENERATED_SUMMARY = GENERATED_DIR / "signalforge_portfolio_selected_trade_sequence_summary.json"
...
def build_stage10_selected_trade_sequence_rebuild_validation() -> dict[str, Any]:
    blockers: list[str] = []
    ...
    if blockers:
        return {
            "adapter_type": "migrated_workflow_stage10_selected_trade_sequence_rebuild_validation_builder",
            "artifact_type": "signalforge_migrated_workflow_stage10_selected_trade_sequence_rebuild_validation",
            "is_ready": False,
    ...
    if source_count != generated_count:
        blockers.append("selected_trade_sequence_row_count_mismatch")

    if source_keys != generated_keys:
        blockers.append("selected_trade_sequence_sample_schema_mismatch")
    ...
    return {
        ...
        "generated_summary_core": {
            ...
            "input_sequence_row_count": summary.get("input_sequence_row_count"),
            "selected_trade_count": summary.get("selected_trade_count"),
            "skipped_trade_count": summary.get("skipped_trade_count"),
        },
        "blocker_count": len(blockers),
        "blockers": blockers,
        "is_ready": len(blockers) == 0,
        "readiness_scope": "migrated_selected_trade_sequence_rebuild_matches_source_row_count_schema_and_hash",
    }


def main() -> int:
    result = build_stage10_selected_trade_sequence_rebuild_validation()

    output_path = OUTPUT_ROOT / "signalforge_migrated_workflow_stage10_selected_trade_sequence_rebuild_validation.json"
