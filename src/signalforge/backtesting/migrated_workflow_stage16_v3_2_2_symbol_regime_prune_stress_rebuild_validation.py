...
SOURCE_DIR = OUTPUT_ROOT / "stage1_artifact_mirror" / "13b_v3_2_2_symbol_regime_prune_stress"
GENERATED_DIR = OUTPUT_ROOT / "stage16_v3_2_2_symbol_regime_prune_stress_rebuild"

ROW_CHECKS = [
    {
        "label": "stress_results",
        "source": SOURCE_DIR / "v3_2_2_prune_stress_results.jsonl",
        "generated": GENERATED_DIR / "signalforge_v3_2_2_symbol_regime_walkforward_prune_stress_results.jsonl",
    },
    {
        "label": "skipped_rows",
        "source": SOURCE_DIR / "v3_2_2_prune_skipped_rows.jsonl",
        "generated": GENERATED_DIR / "signalforge_v3_2_2_symbol_regime_walkforward_prune_skipped_rows.jsonl",
    },
    {
        "label": "30k_ledger",
        "source": SOURCE_DIR / "v3_2_2_30k_ledger.jsonl",
        "generated": GENERATED_DIR / "v3_2_2_30k" / "ledger.jsonl",
    },
    {
        "label": "40k_ledger",
        "source": SOURCE_DIR / "v3_2_2_40k_ledger.jsonl",
        "generated": GENERATED_DIR / "v3_2_2_40k" / "ledger.jsonl",
    },
]

GENERATED_SUMMARY = GENERATED_DIR / "signalforge_v3_2_2_symbol_regime_walkforward_prune_stress_summary.json"
...
def build_stage16_v3_2_2_symbol_regime_prune_stress_rebuild_validation() -> dict[str, Any]:
    blockers: list[str] = []
    ...
    return {
        "adapter_type": "migrated_workflow_stage16_v3_2_2_symbol_regime_prune_stress_rebuild_validation_builder",
        "artifact_type": "signalforge_migrated_workflow_stage16_v3_2_2_symbol_regime_prune_stress_rebuild_validation",
        ...
        "readiness_scope": "migrated_v3_2_2_symbol_regime_prune_stress_rebuild_matches_source_row_count_schema_and_hash",
    }
...
def main() -> int:
    ...
    output_path = OUTPUT_ROOT / "signalforge_migrated_workflow_stage16_v3_2_2_symbol_regime_prune_stress_rebuild_validation.json"
