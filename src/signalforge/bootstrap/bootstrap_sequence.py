...
from signalforge.bootstrap.asset_behavior_bootstrap import build_asset_behavior_bootstrap
from signalforge.bootstrap.closed_outcomes_bootstrap import build_closed_outcomes_bootstrap
from signalforge.bootstrap.market_regime_bootstrap import build_market_regime_bootstrap
from signalforge.bootstrap.option_behavior_bootstrap import build_option_behavior_bootstrap
from signalforge.bootstrap.option_quote_bootstrap import build_option_quote_bootstrap
from signalforge.bootstrap.portfolio_construction_bootstrap import build_portfolio_construction_bootstrap
from signalforge.bootstrap.prior_gate_asof_parity import build_prior_gate_asof_parity
from signalforge.bootstrap.prior_gate_evaluation_outcomes_bootstrap import (
    build_prior_gate_evaluation_outcomes_bootstrap,
)
from signalforge.bootstrap.prior_gate_skipped_row_parity import build_prior_gate_skipped_row_parity
from signalforge.bootstrap.prior_symbol_regime_state_builder import build_prior_symbol_regime_state
from signalforge.bootstrap.strategy_selection_bootstrap import build_strategy_selection_bootstrap
from signalforge.bootstrap.v3_2_2_pre_trade_decisions_bootstrap import build_v3_2_2_pre_trade_decisions_bootstrap
from signalforge.bootstrap.v3_2_2_runtime_readiness_audit import build_v3_2_2_runtime_readiness_audit
...
def build_runtime_bootstrap_sequence(
    *,
    ...
    step_builders: tuple[tuple[str, Callable[[], Any]], ...] = (
        ...
        (
            "portfolio_construction_bootstrap",
            lambda: build_portfolio_construction_bootstrap(seed_bundle=seed_bundle),
        ),
        (
        ...
        (
            "v3_2_2_pre_trade_decisions_bootstrap",
            lambda: build_v3_2_2_pre_trade_decisions_bootstrap(),
        ),
        (
