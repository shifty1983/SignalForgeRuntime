...
from src.options_portfolio.control_report_source_assembler_operation import (
    run_options_portfolio_control_report_source_assembler_operation,
)


FILE_WRITER_SCHEMA_VERSION = "options_portfolio_control_report_source_assembler_files.v1"
OPERATION_TYPE = "options_portfolio_control_report_source_assembler_file_writer"

DEFAULT_FILENAMES = {
    "source_artifact": "options_portfolio_control_report_source.json",
    "assembled_source": "options_portfolio_control_report_assembled_source.json",
    "operation_result": "options_portfolio_control_report_source_assembler_operation.json",
    "audit_report": "options_portfolio_control_report_source_assembler_audit.json",
    "health_report": "options_portfolio_control_report_source_assembler_health.json",
    "events": "options_portfolio_control_report_source_assembler_events.json",
    "event_log": "options_portfolio_control_report_source_assembler_operation.jsonl",
}


def write_options_portfolio_control_report_source_assembler_operation_files(
    source: Any,
    *,
    ...
    operation_result = run_options_portfolio_control_report_source_assembler_operation(
    ...
    source_artifact = _as_mapping(
        operation_result.get("options_portfolio_control_report_source")
    )
    assembled_source = _as_mapping(source_artifact.get("assembled_source"))
    ...
    files = {
        "source_artifact": output_path / DEFAULT_FILENAMES["source_artifact"],
        "assembled_source": output_path / DEFAULT_FILENAMES["assembled_source"],
    ...
    _write_json(files["source_artifact"], source_artifact)
    _write_json(files["assembled_source"], assembled_source)
    ...
    return {
        ...
        "source_summary": _as_mapping(source_artifact.get("source_summary")),
