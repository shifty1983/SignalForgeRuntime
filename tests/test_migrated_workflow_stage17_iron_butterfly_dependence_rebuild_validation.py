...
def test_stage17_iron_butterfly_dependence_rebuild_validation_builds():
    result = build_stage17_iron_butterfly_dependence_rebuild_validation()

    assert result["adapter_type"] == "migrated_workflow_stage17_iron_butterfly_dependence_rebuild_validation_builder"
    assert "blockers" in result


def test_stage17_iron_butterfly_dependence_rebuild_validation_is_ready():
    result = build_stage17_iron_butterfly_dependence_rebuild_validation()
