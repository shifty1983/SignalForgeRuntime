...
def test_stage18_v3_2_2_native_quote_attribution_rebuild_validation_builds():
    result = build_stage18_v3_2_2_native_quote_attribution_rebuild_validation()

    assert result["adapter_type"] == "migrated_workflow_stage18_v3_2_2_native_quote_attribution_rebuild_validation_builder"
    assert "blockers" in result


def test_stage18_v3_2_2_native_quote_attribution_rebuild_validation_is_ready():
    result = build_stage18_v3_2_2_native_quote_attribution_rebuild_validation()
