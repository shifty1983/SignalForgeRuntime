def test_regime_asset_options_alignment_cli_imports() -> None:
    import src.signalforge.engines.alignment.regime_asset_options_alignment_cli  # noqa: F401


def test_regime_asset_options_alignment_file_writer_imports() -> None:
    import src.signalforge.engines.alignment.regime_asset_options_alignment_file_writer  # noqa: F401
