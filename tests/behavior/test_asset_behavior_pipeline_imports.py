def test_market_price_behavior_imports() -> None:
    import signalforge.engines.behavior.market_price_behavior  # noqa: F401


def test_asset_multi_horizon_behavior_imports() -> None:
    import signalforge.engines.behavior.asset_multi_horizon_behavior  # noqa: F401


def test_asset_behavior_selection_imports() -> None:
    import signalforge.engines.behavior.asset_behavior_selection  # noqa: F401


def test_asset_behavior_selection_to_decision_inputs_imports() -> None:
    import signalforge.engines.behavior.asset_behavior_selection_to_decision_inputs  # noqa: F401


def test_asset_behavior_decision_export_imports() -> None:
    import signalforge.engines.behavior.asset_behavior_decision_export  # noqa: F401
