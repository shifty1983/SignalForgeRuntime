...
REPO = Path(".").resolve()
OUT = REPO / "artifacts/stage40c7a_selected_trade_sequence_audit"

TARGETS = [
    REPO / "src/signalforge/backtesting/portfolio_selected_trade_sequence.py",
    REPO / "src/signalforge/backtesting/portfolio_selected_trade_sequence_cli.py",
]

EXPECTED_CORE = REPO / "src/signalforge/engines/portfolio_construction/selected_trade_sequence.py"
...
FOCUS_FUNCTIONS = {
    "build_selected_trade_sequence",
    "build_portfolio_selected_trade_sequence",
    "build_portfolio_selected_trade_sequence_artifact",
    "selected_trade_sequence",
    "trade_key",
    "candidate_key",
    "sequence_key",
    "deduplicate",
    "deduplicate_selected_trades",
    "group_selected_trades",
    "select_trade_sequence",
    "make_trade_row",
    "write_selected_trade_sequence",
}
...
def main() -> int:
    ...
    for path in TARGETS:
        ...
        if core_imports and core_calls:
            ...
            verdict = "not_verified_selected_trade_sequence_logic_owned_by_builder"
        else:
    ...
    blocker_reports = [
        r for r in reports
        if r["verdict"] == "not_verified_selected_trade_sequence_logic_owned_by_builder"
    ]

    summary = {
        "adapter_type": "stage40c7a_selected_trade_sequence_auditor",
        "artifact_type": "signalforge_stage40c7a_selected_trade_sequence_audit",
        "contract": "stage40c7a_selected_trade_sequence_audit",
        "is_ready": len(blocker_reports) == 0 and total_core_import_hits > 0 and total_core_call_hits > 0,
        "stage": "23_selected_trade_sequence_pruned",
        ...
        "paths": {
            "summary_path": "artifacts/stage40c7a_selected_trade_sequence_audit/signalforge_stage40c7a_selected_trade_sequence_audit_summary.json",
            "detail_path": "artifacts/stage40c7a_selected_trade_sequence_audit/signalforge_stage40c7a_selected_trade_sequence_audit_detail.json",
        },
    }
    ...
    (OUT / "signalforge_stage40c7a_selected_trade_sequence_audit_summary.json").write_text(
        json.dumps(summary, indent=2, sort_keys=True),
        encoding="utf-8",
    )

    (OUT / "signalforge_stage40c7a_selected_trade_sequence_audit_detail.json").write_text(
